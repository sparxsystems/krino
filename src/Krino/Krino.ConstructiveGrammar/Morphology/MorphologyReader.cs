...
{
    internal class MorphologyReader
    {
        ...
        public MorphologyReader(IMorphology morphology, IEnumerable<IMorpheme> morphemes)
        {
        ...
        public string[] SplitSentences(string text) => mySplitSentenceItemsRegex.Split(text).Where(x => x != "").ToArray();
        ...
        public IEnumerable<IWord> ReadWord(string word)
        {
            using var _t = Trace.Entering();
