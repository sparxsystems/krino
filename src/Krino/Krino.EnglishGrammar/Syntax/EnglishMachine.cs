...
namespace Krino.EnglishGrammar.Syntax
{
    public class EnglishMachine
    {
        ...
        private void AddPresentSimple(SyntaxMachineBuilder builder, BigInteger attributes)
        {
            ...
            verbElement.AddTriggeredTransition("init", "modal/do/does", WordRules.WordIsOneOf("do", "does", "can", "could", "should", "would"));
            verbElement.AddTriggeredTransition("init", GrammarAttributes.Morpheme.Free.Lexical.Verb.Form.Base);

            verbElement.AddTriggeredTransition("modal/do/does", "not", WordRules.WordIsOneOf("not"));
        ...
        private void AddPresentPerfect(SyntaxMachineBuilder builder, BigInteger attributes)
        {
            ...
            verbElement.AddTriggeredTransition("have/has", "not", WordRules.WordIsOneOf("not"));
        ...
        private void AddPresentContinuousPerfect(SyntaxMachineBuilder builder, BigInteger attributes)
        {
            ...
            verbElement.AddTriggeredTransition("have/has", "been", WordRules.WordIs("been"));
            verbElement.AddTriggeredTransition("have/has", "not", WordRules.WordIs("not"));
        ...
        private void AddFutureSimple(SyntaxMachineBuilder builder, BigInteger attributes)
        {
            ...
            verbElement.AddTriggeredTransition("will", "not", WordRules.WordIsOneOf("not"));
        ...
        private void AddFuturePerfect(SyntaxMachineBuilder builder, BigInteger attributes)
        {
            ...
            verbElement.AddTriggeredTransition("will", "have", WordRules.WordIsOneOf("have"));
