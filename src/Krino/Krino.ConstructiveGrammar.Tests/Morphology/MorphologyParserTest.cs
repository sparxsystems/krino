...
namespace Krino.ConstructiveGrammar.Tests.Morphology
{
    ...
    public class MorphologyParserTest
    {
        ...
        public void Split()
        {
            ...
            var parser = new MorphologyParser(morphology, MorphemeProvider.Morphemes);
        ...
        public void FindMorphemeSequences()
        {
            ...
            var dictionary = new MorphologyParser(morphology, morphemes);
        ...
        public void FindMorphemeSequences_DropE()
        {
            ...
            Assert.AreEqual(1, morphemeSequences.Count);

            Assert.AreEqual(2, morphemeSequences[0].Morphemes.Count());
            Assert.AreEqual("write", morphemeSequences[0].Roots[0].Value);
            Assert.AreEqual("er", morphemeSequences[0].Suffixes[0].Value);
        }
    }
}
