...
namespace Krino.Domain.ConstructiveAdpositionalGrammar.Parsing
{
    public class AdTreeCreator2
    {
        ...
        private MultiMachine<LinguisticState, BigInteger> myGrammarMachine;

        public AdTreeCreator2(IConstructiveDictionary constructiveDictionary, MultiMachine<LinguisticState, BigInteger> grammarMachine)
        {
            myConstructiveDictionary = constructiveDictionary;
            myGrammarMachine = grammarMachine;
        }
