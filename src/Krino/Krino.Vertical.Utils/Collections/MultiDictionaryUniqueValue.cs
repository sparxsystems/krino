...
namespace Krino.Vertical.Utils.Collections
{
    ...
    public class MultiDictionaryUniqueValue<K, V> : IEnumerable<KeyValuePair<K, V>>
    {
        private Dictionary<K, HashSet<V>> myDictionary;
        private IEqualityComparer<V> myValueComparer;

        public MultiDictionaryUniqueValue(IEqualityComparer<K> keyComparer = null, IEqualityComparer<V> valueComparer = null)
        {
