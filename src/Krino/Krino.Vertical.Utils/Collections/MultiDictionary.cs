...
{
    /// <summary>
    /// Dictionary which can have multiple values for one key. But only one same value for one key.
    /// </summary>
    ...
    public class MultiDictionary<K, V> : IEnumerable<KeyValuePair<K, V>>
    {
        ...
        public MultiDictionary(IEqualityComparer<K> keyComparer = null, IEqualityComparer<V> valueComparer = null)
        {
        ...
        {
            get => new ReadOnlySet<V>(myDictionary[key]);
