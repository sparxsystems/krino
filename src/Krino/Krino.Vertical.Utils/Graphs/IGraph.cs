...
{
    public interface IGraph<V, E> : IReadOnlyCollection<Vertex<V>>
    {
        /// <summary>
        ...
        void AddEdge(string fromId, string toId, string type, E edgeValue);

        /// <summary>
        /// Removes specified edges.
        /// </summary>
        /// <param name="edgesToRemove"></param>
        bool RemoveEdges(IEnumerable<Edge<E>> edgesToRemove);
        ...
        /// <returns></returns>
        bool RemoveEdgesGoingFrom(string fromId, Predicate<Edge<E>> predicate = null);
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        bool RemoveEdgesGoingTo(string toId, Predicate<Edge<E>> predicate = null);

        /// <summary>
        /// Returns all edges.
        /// </summary>
        /// <returns></returns>
        IEnumerable<Edge<E>> Edges { get; }
        ...
        /// <param name="fromId"></param>
        /// <returns></returns>
        IEnumerable<Edge<E>> GetEdgesGoingFrom(string fromId);
        ...
        /// <param name="toId"></param>
        /// <returns></returns>
        IEnumerable<Edge<E>> GetEdgesGoingTo(string toId);
        ...
        /// <param name="toId"></param>
        /// <returns></returns>
        IEnumerable<Edge<E>> GetEdges(string fromId, string toId);
    }
}
