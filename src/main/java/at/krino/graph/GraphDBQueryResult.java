...
/**
 * A marker (i.e., method-less) interface for graph database query results as returned by the graph database 
 * abstraction layer. There is no mechanism to obtain, from a query result, its originating query, which has 
